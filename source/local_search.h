...
namespace LocalSearch {
    void hill_climb_random          (std::unique_ptr<Instance>& instance, unsigned int budget = 1024, std::ofstream* out = nullptr);
    void hill_climb_first           (std::unique_ptr<Instance>& instance, unsigned int budget = 1024, std::ofstream* out = nullptr);
    void hill_climb_cycle           (std::unique_ptr<Instance>& instance, unsigned int budget = 1024, std::ofstream* out = nullptr);
    void hill_climb_best            (std::unique_ptr<Instance>& instance, unsigned int budget = 1024, std::ofstream* out = nullptr);
    void hill_climb_least           (std::unique_ptr<Instance>& instance, unsigned int budget = 1024, std::ofstream* out = nullptr);
    ...
    void hill_climb_greedy_least    (std::unique_ptr<Instance>& instance, unsigned int budget = 1024, std::ofstream* out = nullptr);
    ...
    void hill_climb_greedy_all_least(std::unique_ptr<Instance>& instance, unsigned int budget = 1024, std::ofstream* out = nullptr);
}